...
const { createTestScheduler, TestWatcher } = require("jest");
...
createMenuItem('waffle', 4, 'breakfast')
createMenuItem('potato', 1, 'dinner')
...
function getLastReview(array) {
  // const lastItem = a
  return `${array.slice(-1).name} gave the restaurant a ${array.slice(-1).rating} star review, and their feedback was: ${array.slice(-1).feedback}`
} 
